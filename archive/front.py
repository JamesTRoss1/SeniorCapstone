import sys
from PyQt6.QtWidgets import QApplication, QWidget, QLabel, QVBoxLayout, QPushButton, QStackedWidget, QLineEdit, QProgressBar
...
class Screen1(QWidget):
    def __init__(self, stack, screen2):
       ...
       # text_font = QFont("Arial", 14)
        ...
        self.style_button(start_button)  # Apply styling

        layout.addWidget(label)
        layout.addWidget(start_button)
        layout.setSpacing(10)  # Improve spacing
...
class Screen3(QWidget):
    def __init__(self, stack):
        ...
        self.style_button(self.submit_button)  # Apply styling

        #Restart Button
        self.restart_button = QPushButton("Restart")
        self.restart_button.clicked.connect(self.restart)
        self.style_button(self.restart_button)  # Apply styling
        ...
        layout.setSpacing(15)  # Improved spacing
